...
import { ShoppingCart, DollarSign, Users, Package, AlertCircle, Crown } from 'lucide-react';
      ...
      <div className="dashboard">
        ...
        <div className="stats-grid">
          ...
          <div className="stat-card">
            ...
            <div className="stat-content">
              <h3>VIP Users</h3>
              <p className="stat-number">{stats.vip_users || 0}</p>
            </div>
          </div>

          <div className="stat-card">
            <div className="stat-icon" style={{background: 'linear-gradient(135deg, #ff6b6b 0%, #ff8e8e 100%)'}}>
              <Package />
            </div>
            <div className="stat-content">
              <h3>Categories</h3>
